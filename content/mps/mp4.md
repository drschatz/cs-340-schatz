...
# Learning Goals
1. Build a deeper mental model of how memory works beneath C's abstractions.
2. Be able to iteratively develop complex logic using C.

# Initial Files
[`mp4.zip`](../mp4.zip) contains a very simple, space-inefficient solution
