...
- The 3 Exams
- Final Project Check-Off (during the [final exam period](https://registrar.illinois.edu/courses-grades/final-exam-schedule-public/))
...
**55% - Exams**
    ...
    - Exams are 50 minutes and given in the CBTF (always a Thursday). The Thursday class session will be canceled for the week of each exam. We recommend taking the exam during the time you have allotted for class (but you are free to schedule it for any time that day).
    - Each exam will have an optional, second-chance exam available the following week, also in the CBTF (the next Thursday for exams 1 and 2, the next Wednesday for exam 3). Your score for the exam, if you take the second chance exam, will be 80% of your higher scored exam and 20% of your lower scored exam. You must sign up for a CBTF slot for the second chance exam like you would for the regular exam. 
...
**5% - Final Project Check-Off**
    - The final project will be checked off during the [university-assigned finals period](https://registrar.illinois.edu/courses-grades/final-exam-schedule-public/). Attendance is required. 
