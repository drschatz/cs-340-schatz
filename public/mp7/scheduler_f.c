...
int main(int argc, char **argv) {
    ...
    /* BUG: sort reversed */ qsort(results, n_results, sizeof(Result), cmp_result_by_id); for(int _i=0,_j=n_results-1;_i<_j;_i++,_j--){Result _t=results[_i];results[_i]=results[_j];results[_j]=_t;}
